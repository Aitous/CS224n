...
[nltk\_data]     C:\textbackslash{}Users\textbackslash{}youss\textbackslash{}AppData\textbackslash{}Roaming\textbackslash{}nltk\_data{\ldots}
...
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{n}{corpus\PYZus{}words} \PY{o}{=} \PY{n+nb}{set}\PY{p}{(}\PY{p}{)}
    ...
    \PY{n}{corpus\PYZus{}words} \PY{o}{=} \PY{n}{corpus\PYZus{}words}\PY{o}{.}\PY{n}{union}\PY{p}{(}\PY{o}{*}\PY{p}{[}\PY{n+nb}{set}\PY{p}{(}\PY{n}{lst}\PY{p}{)} \PY{k}{for} \PY{n}{lst} \PY{o+ow}{in} \PY{n}{corpus}\PY{p}{]}\PY{p}{)}
...
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    ...
    \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
    \PY{c+c1}{\PYZsh{} Write your implementation here.}
    \PY{n}{word2ind} \PY{o}{=} \PY{p}{\PYZob{}}\PY{n}{wrd}\PY{p}{:}\PY{n}{idx} \PY{k}{for} \PY{n}{idx}\PY{p}{,}\PY{n}{wrd} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{words}\PY{p}{)}\PY{p}{\PYZcb{}}
    \PY{k}{for} \PY{n}{sentence} \PY{o+ow}{in} \PY{n}{corpus}\PY{p}{:}
        \PY{k}{for} \PY{n}{idx}\PY{p}{,}\PY{n}{word} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{sentence}\PY{p}{)}\PY{p}{:}
            \PY{k}{for} \PY{n}{context} \PY{o+ow}{in} \PY{n}{sentence}\PY{p}{[}\PY{n}{idx}\PY{o}{\PYZhy{}}\PY{n}{window\PYZus{}size}\PY{p}{:}\PY{n}{idx}\PY{p}{]} \PY{o}{+} \PY{n}{sentence}\PY{p}{[}\PY{n}{idx}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{:}\PY{n}{idx}\PY{o}{+}\PY{n}{window\PYZus{}size}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{:}
                \PY{n}{M}\PY{p}{[}\PY{n}{word2ind}\PY{p}{[}\PY{n}{word}\PY{p}{]}\PY{p}{,} \PY{n}{word2ind}\PY{p}{[}\PY{n}{context}\PY{p}{]}\PY{p}{]} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
    \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
...
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    ...
    \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
    \PY{c+c1}{\PYZsh{} Write your implementation here.}
    \PY{n}{embeddings} \PY{o}{=} \PY{n}{M\PYZus{}reduced}\PY{p}{[}\PY{p}{[}\PY{n}{word2ind}\PY{p}{[}\PY{n}{wrd}\PY{p}{]} \PY{k}{for} \PY{n}{wrd} \PY{o+ow}{in} \PY{n}{words}\PY{p}{]}\PY{p}{]}
    \PY{n}{X}\PY{p}{,} \PY{n}{Y} \PY{o}{=} \PY{n}{embeddings}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{embeddings}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}
    ...
    \PY{k}{for} \PY{n}{index}\PY{p}{,}\PY{n}{x} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{X}\PY{p}{)}\PY{p}{:}
        \PY{n}{plt}\PY{o}{.}\PY{n}{text}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{Y}\PY{p}{[}\PY{n}{index}\PY{p}{]}\PY{p}{,} \PY{n}{words}\PY{p}{[}\PY{n}{index}\PY{p}{]}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{l+m+mi}{12}\PY{p}{)}
    \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
\end{Verbatim}
\end{tcolorbox}
...
Done.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{exploring_word_vectors_files/exploring_word_vectors_23_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
The clustering will depend on the threshold (how close two words have to
be to be considered to belong to the same cluster). We can see that
barrels and output cluster together reasonably because the are both
related to the oil production (even if the distance between them is
larger comapred to the one between countries). Oil, Energy, Kuwait,
Ecuador and Iraq are often used in the same context and therefore are
also expected to be clustered together and finally it is also reasonable
to see industry and petroleum clustered together too. Energy somehow
belongs to both clusters but it is closer to countries and oil. I
expected ``bpd'' to be clustered with barrels and output because it also
reftects oil production and is used offten with these two words, but
this wasn't the case. I was also expecting oil to be closer to petroleum
and energy.
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{exploring_word_vectors_files/exploring_word_vectors_34_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Once again the clustering will depend on the defined thershold and
linkage. We can see that oil, kuwait, petroleum, ecuador and, iraq which
is different from what we had before. .Barrels and output are still
clustered together similar to the cluster we had before (the distance is
still somehow larger that the one between words in other clusters).
There is also a clear cluster containing energy and industry. Finally,
bdp is far away from all the other words. The difference with the
previous plot is for the first cluster, in the previous plot we had
countries clearly cluster but in the current plot they aren't as closed.
petroleum is also far from industry which wasn't the case in the
previous plot. The difference can be due how embeddings are produced in
both approaches, for the co-occurance is more about the words appearing
in each other contexts but in GloVe it is about maximizing the
probability of the words appearing in each other context compared to
other words.
...
\begin{Verbatim}[commandchars=\\\{\}]
    \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
    \PY{c+c1}{\PYZsh{} Write your implementation here.}
    \PY{n+nb}{print}\PY{p}{(}\PY{n}{wv\PYZus{}from\PYZus{}bin}\PY{o}{.}\PY{n}{most\PYZus{}similar}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{miss}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
    \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
\end{Verbatim}
\end{tcolorbox}

    \begin{Verbatim}[commandchars=\\\{\}]
[('pageant', 0.6072248816490173), ('missed', 0.5869234800338745), ('she',
0.5329381227493286), ('play', 0.5224295854568481), ('misses',
0.4893417954444885), ('sister', 0.48914581537246704), ('beauty',
0.48881736397743225), ('chance', 0.4857710301876068), ('pageants',
0.4787732660770416), ('again', 0.4745550751686096)]
    \end{Verbatim}

    \hypertarget{write-your-answer-here.}{%
\paragraph{Write your answer here.}\label{write-your-answer-here.}}

The word I discovered is ``miss''. It has the meagning of ``failing to
reach'' (related to ``chance'' and ``again'' above) and also the
meagning of ``young unmarried woman or girl'' (related to ``she'' or
other words above). The words I tried didn't work because for words to
have similarity they have to have close embeddings, which means they
should appear in similar context which is not easy.
...
\begin{Verbatim}[commandchars=\\\{\}]
    \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
    \PY{c+c1}{\PYZsh{} Write your implementation here.}
    \PY{n+nb}{print}\PY{p}{(}\PY{n}{wv\PYZus{}from\PYZus{}bin}\PY{o}{.}\PY{n}{distance}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{unpleasing}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ugly}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
    \PY{n+nb}{print}\PY{p}{(}\PY{n}{wv\PYZus{}from\PYZus{}bin}\PY{o}{.}\PY{n}{distance}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{beautiful}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ugly}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
    \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
\end{Verbatim}
\end{tcolorbox}
...
``beautiful''. We can see that ``unpleasing'' is a synonym of ``ugly''
and ``beautiful'' is an antonym of ``ugly'' but the distance between the
antonyms is smaller than the one between synonyms. A possible
explaination is that beautiful and ugly are used in similar contexts but
ugly and unpleasing are used in very different contexts.
...
\begin{Verbatim}[commandchars=\\\{\}]
    \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
    \PY{c+c1}{\PYZsh{} Write your implementation here.}
    \PY{n}{pprint}\PY{o}{.}\PY{n}{pprint}\PY{p}{(}\PY{n}{wv\PYZus{}from\PYZus{}bin}\PY{o}{.}\PY{n}{most\PYZus{}similar}\PY{p}{(}\PY{n}{positive}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{aunt}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{man}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{negative}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{uncle}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
    \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
    \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
    \PY{c+c1}{\PYZsh{} Write your implementation here.}
    \PY{n}{pprint}\PY{o}{.}\PY{n}{pprint}\PY{p}{(}\PY{n}{wv\PYZus{}from\PYZus{}bin}\PY{o}{.}\PY{n}{most\PYZus{}similar}\PY{p}{(}\PY{n}{positive}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{food}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{mouth}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{negative}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{scent}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
    \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
\end{Verbatim}
\end{tcolorbox}
...
The intended analogy is food:mouth :: scent:nose. I got food:mouth ::
scent:feed
...
We can see that the female-associated words contain more of the nursing,
home and children related jobs and the male-associated jobs contain
factory, hand-based jobs. These findings illustrate the gender bias
about the jobs we think are more suitable to women/men.
...
\begin{Verbatim}[commandchars=\\\{\}]
    \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
    \PY{c+c1}{\PYZsh{} Write your implementation here.}
    \PY{n}{pprint}\PY{o}{.}\PY{n}{pprint}\PY{p}{(}\PY{n}{wv\PYZus{}from\PYZus{}bin}\PY{o}{.}\PY{n}{most\PYZus{}similar}\PY{p}{(}\PY{n}{positive}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{white}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{worker}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{negative}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{black}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
    \PY{n+nb}{print}\PY{p}{(}\PY{p}{)}
    \PY{n}{pprint}\PY{o}{.}\PY{n}{pprint}\PY{p}{(}\PY{n}{wv\PYZus{}from\PYZus{}bin}\PY{o}{.}\PY{n}{most\PYZus{}similar}\PY{p}{(}\PY{n}{positive}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{black}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{worker}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{negative}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{white}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
    \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
\end{Verbatim}
\end{tcolorbox}
...
We can see from the example above the bias we have in terms of race. In
the first list, we notice `working', `employee' as words close to `white
and 'worker' and far from `black'. In the second list, we notice
`unemployed' and `immigrant' as words close to `black' and `worker' and
far from `white'. This shows a clear racial bias.
...
The bias comes from training examples which contain biased knowledge. To
check this we can feed the model with some training data that have the
inversed bias and see how it behaves.
